...
function AdminMatchedItems() {
  ...
  const fetchItems = async () => {
    ...
    setItems(data.filter((i) => i.status === "matched"));
  };
    ...
    <div className="admin-panel">
      ...
      <main className="dashboard-content">
        ...
        <div className="items-list">
          ...
          {items.length === 0 && <p>No matched items.</p>}
        </div>
      </main>
    </div>
  );
...
export default withAuthenticationRequired(AdminMatchedItems, {
