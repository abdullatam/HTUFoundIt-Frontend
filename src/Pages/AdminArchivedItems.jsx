...
function AdminArchivedItems() {
  ...
  const fetchItems = async () => {
    ...
    setItems(data.filter((i) => i.status === "archived"));
  };
    ...
    <div className="admin-panel">
      ...
      <main className="dashboard-content">
        ...
        <div className="items-list">
          ...
          {items.length === 0 && <p>No archived items.</p>}
        </div>
      </main>
    </div>
  );
...
export default withAuthenticationRequired(AdminArchivedItems, {
